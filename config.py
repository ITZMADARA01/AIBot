...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Yash-coder53/AIBot.git")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN")

# Fill this variable if your upstream repository is private
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/slayer_logs")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/gravesofhumanity")
...
if SUPPORT_CHAT:
    if not re.match("https://t.me/", SUPPORT_CHAT):
        raise SystemExit(
